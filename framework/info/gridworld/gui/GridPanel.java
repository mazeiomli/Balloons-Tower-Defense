        ...
        PseudoInfiniteViewport.Pannable
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g2.fillRect(insets.left, insets.top, numCols * (cellSize + 1) + 1, numRows
                * (cellSize + 1) + 1);
        //Beginning of code to use an image as the background
        BufferedImage img = null;
        try{
        	//Enter image name there. Put file in the GridWorldCodeGame folder
        	img = ImageIO.read(new File("PathFinal.gif"));
        }catch(IOException e){
        }
